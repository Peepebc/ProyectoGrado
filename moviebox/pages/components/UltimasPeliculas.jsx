...
export default function UltimasPeliculas() {
  return (
    <section className='p-10'>
      <div className='flex justify-between border-b-2 px-3'>
        ...
        <div className="flex flex-wrap md:flex-nowrap gap-5 py-5 justify-evenly">
          <Link href={'/pelicula/2'}><img className='w-36 h-52 md:w-52 md:h-80 rounded-xl' src="https://moviebox-pelis.s3.us-east-005.backblazeb2.com/Peliculas/1580999639_454991_1581001437_album_normal.jpg" alt="" /></Link>
